  ...
  class Mt extends V {
    constructor(t, e) {
      super(t, e),
        ...
        (this._menu =
          U.next(this._element, kt)[0] || U.prev(this._element, kt)[0]),
    ...
    _getPlacement() {
      ...
      return t.classList.contains('dropup') ? (e ? It : Lt) : e ? St : Ot
    }
    _detectNavbar() {
    ...
    static dataApiKeydownHandler(t) {
      ...
      const n = this.matches(Et)
          ? this
          : U.prev(this, Et)[0] || U.next(this, Et)[0],
      ...
      for (const e of t)
        if ('click' === e)
          ...
          $.on(this._element, t, this._config.selector, (t) => {
            const e = this._initializeOnDelegatedTarget(t)
            ;(e._activeTrigger['focusin' === t.type ? Oe : Ie] = !0), e._enter()
          }),
            $.on(this._element, i, this._config.selector, (t) => {
              const e = this._initializeOnDelegatedTarget(t)
              ;(e._activeTrigger['focusout' === t.type ? Oe : Ie] =
